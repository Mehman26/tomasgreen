...
import { ArrowRight, CheckCircle, Users, Award, Sparkles, Leaf, Package } from 'lucide-react';
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="relative z-20 w-full max-w-6xl mx-auto text-center">
          <div className="mb-6 sm:mb-8">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 text-white leading-tight px-2" style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.8), 0 0 16px rgba(0,0,0,0.6)' }}>
              {t('heroTitle')}
            </h1>
          </div>
          
          <div className="mb-8 sm:mb-10 md:mb-12">
            <p className="text-lg sm:text-xl md:text-2xl text-white max-w-4xl mx-auto leading-relaxed px-2" style={{ textShadow: '1px 1px 4px rgba(0,0,0,0.7), 0 0 8px rgba(0,0,0,0.5)' }}>
              {t('heroSubtitle')}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-10 md:mb-12">
            {[
              ...
              },
              {
                ...
                image: "https://images.unsplash.com/photo-1649255613648-b10b8a4b1a5b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzZWVkcyUyMHN1bmZsb3dlciUyMHB1bXBraW4lMjBoZWFsdGh5fGVufDF8fHx8MTc1NjYyNTI3MHww&ixlib=rb-4.1.0&q=80&w=1080",
